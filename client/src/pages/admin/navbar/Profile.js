...
import Createdesignationmod from '../users/Createdesignation';
...
function Adminuserprofilelist() {
    ...
    return (
        <Box>
            ...
            <Typography sx={userStyle.HeaderText}>Profile</Typography>
